    ...
    render() {
        return (
            <div className='currentProjectInformation' id='currentProjectInformation'>
                ...
                <p>
                    The wireframe I had for this project was almost exactly to what you're seeing now, please see the image, the only things that immediately
                    changed was the color pallet went from mostly black and blue to off black, darker blue, and off white. I reached out to some people to help me with the hex codes.
                ...
                <img src={require('./pictures/fireframe.jpg')} alt='wireframe' className='wireframe' />
            </div>
        );
    }
}
